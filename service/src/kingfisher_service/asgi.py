...
submodule called `app`, so `kingfisher_service:app` resolves to that module and
...
Configured from the environment, by the same `ServiceConfig.from_env` the entry
