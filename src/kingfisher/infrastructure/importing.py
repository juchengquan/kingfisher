...
Moved out of `tools`, unchanged, because tools stopped being the only kind that is
code. A workspace may now define a subagent as a compiled graph, and that arrives the
same way a tool does: a file or a folder under a catalogue, imported into this
process and asked what it declares.
"""
